...
public class MainActivity extends Activity {
    ...
    private SimpleDashboardView dashboardView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dashboardView = new SimpleDashboardView(this);
...
// 独立的静态视图类，彻底杜绝编译时的类作用域冲突
class SimpleDashboardView extends View {
    ...
    public SimpleDashboardView(Context context) {
        super(context);
        setClickable(true);
